...
function load() {
    ...
    //Room lights
    let roomSpotLightWall1 = new THREE.SpotLight(0xD0140E, 1.5)
    ...
    let roomSpotLightWall3 = new THREE.SpotLight(0xD0140E, 1)
    ...
    let roomSpotLightWall4 = new THREE.SpotLight(0x9400FF, 1.5)
